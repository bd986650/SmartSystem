...
import com.example.smartsystem.UPnPDevice
import com.example.smartsystem.UPnPDiscovery
...
class SearchDevicesActivity : AppCompatActivity(), RecyclerViewHelperInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = DeviceDiscoveryListAdapter(arrayListOf(
            ListViewItem(
